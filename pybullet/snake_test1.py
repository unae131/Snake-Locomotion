...
for i in range(10):
	clothId = p.loadSoftBody("sphere_smooth.obj", basePosition = [0,0+i*0.5,1], scale = 0.35, mass = 1.,useNeoHookean = 0, useBendingSprings=1,useMassSpring=1, springElasticStiffness=40,springDampingStiffness=10, springDampingAllDirections = 1,useSelfCollision = 0, frictionCoeff = .5, useFaceContact=1)
